...
export default function Register() {
    ...
    return (
        <GuestLayout>
            ...
            <h1 className="mb-1 text-xl font-semibold text-white">Create your LeadGen CRM account</h1>
            <p className="mb-6 text-sm text-slate-400">Start managing leads and sales activities in one place.</p>
